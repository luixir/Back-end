				...
				<div class="row-fluid">
					<div class="left">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="inputarea" placeholder="area" name="area">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="inputDiscountedPrice"
									placeholder="Discounted price" name="discountPrice"> <abbr
									title="16">eg</abbr>
							</div>
						</div>
						...
						<div class="control-group">
							<label class="control-label" for="inputContent">Consumed
								number</label>
							<div class="controls">
								<input type="text" id="inputContent" placeholder="Content"
									name="consumedNumber">
						...
						<div class="control-group">
							...
							<c:forEach var="listcategory" items="${listcategory}"
								...
								<label class="radio inline"> <input type="radio"
									name="category.id" id="optionsRadios${theCount.count}"
									value="${listcategory.id}"> ${listcategory.name}
								</label>
							</c:forEach>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="inputItemDetailName"
									placeholder="item detail name" name="itemContent"> <abbr
									title="代金券">eg</abbr>
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="inputItemDetailTotal" placeholder="total"
									name="originalTotalPrice"> <abbr title="20">eg</abbr>
							</div>
						</div>
